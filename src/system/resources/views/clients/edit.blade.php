    ...
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <h6 class="card-title">Editar Cliente: {{ $client->name }}</h6>

                <form class="forms-sample" method="POST" action="{{ route('clients.update', $client) }}" novalidate>
                    @csrf
                    @method('PUT') {{-- Importante: para enviar como PUT/PATCH --}}

                    {{-- Dados básicos --}}
                    <div class="mb-3">
                        <label class="form-label" for="name">Nome/Razão Social <span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                               id="name" name="name" value="{{ old('name', $client->name) }}" placeholder="Ex.: Delta Coding Ltda" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" inputmode="numeric" maxlength="14"
                               ...
                               id="cnpj" name="cnpj" value="{{ old('cnpj', $client->cnpj) }}" placeholder="Ex.: 12345678000199" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                               id="email" name="email" value="{{ old('email', $client->email) }}" placeholder="contato@empresa.com.br">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" inputmode="numeric" class="form-control @error('phone') is-invalid @enderror"
                               id="phone" name="phone" value="{{ old('phone', $client->phone) }}" placeholder="27999998888">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" inputmode="numeric" maxlength="9"
                                   ...
                                   id="cep" name="cep" value="{{ old('cep', $client->cep ? substr($client->cep, 0, 5) . '-' . substr($client->cep, 5, 3) : '') }}" placeholder="00000-000">
                    ...
                    {{-- Campo oculto para codigo_ibge --}}
                    <input type="hidden" id="codigo_ibge" name="codigo_ibge" value="{{ old('codigo_ibge', $client->codigo_ibge) }}">

                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label" for="latitude">Latitude</label>
                                <input type="text" readonly class="form-control" id="latitude" name="latitude" value="{{ old('latitude', $client->latitude) }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label" for="longitude">Longitude</label>
                                <input type="text" readonly class="form-control" id="longitude" name="longitude" value="{{ old('longitude', $client->longitude) }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('street') is-invalid @enderror"
                                       id="street" name="street" value="{{ old('street', $client->street) }}" placeholder="Preenchido ao buscar CEP">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('complement') is-invalid @enderror"
                                       id="complement" name="complement" value="{{ old('complement', $client->complement) }}" placeholder="Sala 402, Apto 101..." required>
                        ...
                        <div class="col-md-5">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('city') is-invalid @enderror"
                                       id="city" name="city" value="{{ old('city', $client->city) }}" placeholder="Preenchido ao buscar CEP">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('district') is-invalid @enderror"
                                       id="district" name="district" value="{{ old('district', $client->district) }}" placeholder="Preenchido ao buscar CEP">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('state') is-invalid @enderror"
                                       id="state" name="state" value="{{ old('state', $client->state) }}" placeholder="UF" maxlength="2" style="text-transform: uppercase;">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('machines') is-invalid @enderror"
                                  ...
                                  placeholder="Ex.: Impressora HP LaserJet M402; PC Financeiro (i5/8GB/SSD256); CNC XYZ…">{{ old('machines', $client->machines) }}</textarea>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const lngField   = $('#longitude'); // A LINHA DE ERRO FOI REMOVIDA DAQUI
    ...
    // ✅ MELHORIA: Aplica a máscara no valor inicial ao carregar a página
    if (cepInput.value) {
    ...
    // A lógica do 'click' continua exatamente a mesma
    btnBuscar.addEventListener('click', async () => {
        ...
        try {
            ...
            cepInput.value = maskCep(via.cep || raw || '');
