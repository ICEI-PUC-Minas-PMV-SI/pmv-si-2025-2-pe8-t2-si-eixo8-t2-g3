...
// rota extra para encerrar OS
Route::post('service-orders/{service_order}/close', [ServiceOrderController::class, 'close'])
...
// routes/web.php
Route::get('/service-orders/{service_order}/pdf', [\App\Http\Controllers\ServiceOrderController::class, 'pdf'])
